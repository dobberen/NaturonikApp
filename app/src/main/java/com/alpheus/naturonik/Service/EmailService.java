...
public class EmailService {
    ...
    private static final String SMTP_AUTH_USER = "naturonik.ru@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "naturonik10!"; //password/secret
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        props.setProperty("mail.mime.charser", "UTF-8");
        ...
        try {
            ...
            messageBodyPart.setContent(msg, "text/plain; charset=\"UTF-8\"");
